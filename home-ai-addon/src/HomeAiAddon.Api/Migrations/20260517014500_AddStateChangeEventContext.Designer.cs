...
namespace HomeAiAddon.Api.Migrations
{
    ...
    [Migration("20260517014500_AddStateChangeEventContext")]
    partial class AddStateChangeEventContext
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HomeAiAddon.Api.Data.Entities.StateChangeEventRecord", b =>
                {
                    ...
                    b.Property<string>("ContextParentId")
                        .HasMaxLength(64)
                        .HasColumnType("TEXT");
